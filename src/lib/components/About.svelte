...
<div class="container mx-auto p-8 space-y-8">
  ...
  <dl class="list-dl">
    ...
    <div>
      <span class="badge bg-primary-500">🏭</span>
      <span class="flex-auto">
        <dt class="font-bold">Framework</dt>
        <dd class="text-sm"><a href="https://kit.svelte.dev/" target="_blank">SvelteKit</a></dd>
      </span>
    </div>
    <div>
      <span class="badge bg-primary-500">🎨</span>
      <span class="flex-auto">
        <dt class="font-bold">UI</dt>
        <dd class="text-sm"><a href="https://www.skeleton.dev/" target="_blank">Skeleton</a></dd>
      </span>
    </div>
    <div>
      <span class="badge bg-primary-500">👌</span>
      <span class="flex-auto">
        <dt class="font-bold">Validation</dt>
        <dd class="text-sm">
          <a href="https://superforms.vercel.app/" target="_blank">Superforms</a>
        </dd>
      </span>
    </div>
    <div>
